...
<style>
    ...
    .login-area button[type=submit]{height:50px;}

    .nav-area{background:black; color:white; height:50px;}
    .menu{
        display:table-cell;
        width:250px;
        height:50px;
		            ...
		            <table>
		                ...
		                <tr>
		                    <td colspan="3" align="center">
		                        ...
		                        <!-- 
		                        	enrollForm.me로 요청시 구동이 될 Servlet클래스 만들기 (MemberEnrollFormController)
